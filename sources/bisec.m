function bisec
% ........................................................
% .  Cálculo de raíces utilizando el Método de Bisección .
...
% Función asociada al botón "Calcular"
    function calcularFcn(src,event)
        global XR E n
        cla;
        f=get(df,'str');
...
% Función asociada al botón "Ver Tabla"
    function tabla(src,event)
        global XR E n
...
% Función asociada al botón "Borrar"
    function borrarFcn(src,event)
        cla;
